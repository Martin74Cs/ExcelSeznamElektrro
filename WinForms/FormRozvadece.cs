...
namespace WinForms
{
    public partial class FormRozvadece: Form {
        ...
        private void ObnovZarizeni() {
            ...
            var neprirazena = _seznamZarizeni.Where(z => string.IsNullOrWhiteSpace(z.Rozvadec)).ToList();
        ...
        private void dataGridViewNeprirazeno_CellContentClick(object sender, DataGridViewCellEventArgs e) {
